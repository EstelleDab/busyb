...
<body class="bg-dark">
    ...
    <main class='bg-light'>
        ...
        <div class='d-flex flex-column justify-content-start'>
           ...
           <div class='h-50 hexaline mb-4 mt-4 d-flex flex-row  '>
                <div class='d-flex flex-column w-10 mb-9'> 
                ...
                <div class='mycolumn d-flex flex-column w-10 mt-5'>
            ...
            <div class='mycolumn d-flex flex-column mt-5 w-10'>
