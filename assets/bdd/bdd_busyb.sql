...
(4,'stage', 'Développeur(euse) Web Front\-End', 'De formation Web, à la recherche d\'un stage de fin d\'étude vous connaissez toutes les étapes de la réalisation d’une interface riche. 
Rattaché(e) à l’équipe technique, vous participerez aux projets de développement de sites internet / intranet ou d’applications web sur des CMS Open Source : Drupal, WordPress et Automne CMS.'),
(5,'stage', 'Community Manager', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(6,'CDI', 'Designer interfaces', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(7,'stage', 'Développeur full stack', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(8,'CDD', 'Project Manager', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(9,'CDI', 'Data analyst', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(10,'CDI', 'Graphiste', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(11,'stage', 'Community Manager', 'Etudiant en formation DEUST ou BUT, ayant une bonne connaissance des principes clés du SEO et maitrisant les différentes plateformes de réseaux sociaux vous avez une bonne aisance rédactionnelle
et avez une expérience en publication de contenu sous toutes leur forme'),
(12,'CDD', 'Développeur back-end', 'Nous cherchons un(e) concepteur/trice, rédacteur/rice web pour créer des contenus engageants. Votre plume et votre créativité contribueront à valoriser l’identité de nos clients et à engager leur audience.
');
