...
<body class="bg-dark">
    ...
    <main class='bg-light'>
        ...
        <div class='d-flex flex-column justify-content-start'>
            ...
            <div class='h-50 hexaline px-5 mx-5 mb-4 mt-4 d-flex flex-row justify-content-start align-items-center '>
                <div class='carte'>
                    <div  id='js-ama' class='carte__inner mb-5'>
                ...
                <div class='carte'>
                    <div id='js-ste' class='carte__inner mb-5'>
                                <div class="carte__face carte__face--front d-flex align-items-center justify-content-center">
                    ...
                    <div class='carte'>
                    <div id='js-fra' class='carte__inner mb-5'>
                                <div class="carte__face carte__face--front d-flex align-items-center justify-content-center">
            ...
            <!--
            <div class='px-5 mx-5 mb-4 mt-4 d-flex flex-row justify-content-start align-items-center '>
