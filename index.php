			...
			<ul id="hexalist" class="h-100"  >
				...
				<div class="hex-gap h-100 d-flex flex-row justify-content-center align-items-center">
					...
					<div class=" d-flex flex-column  align-items-center">
						...
						<li id="js-hexa1" class="hex hex-nav yellow"><span class="link"><a class='nav-link' >contact</a></span></li>
					</div>
					<div class=" d-flex flex-column  align-items-center">
						<li id="js-hexa2" class="hex hex-nav yellow"><span class="link"><a class='nav-link' href="expertise.php">notre texpertise</a></span></li>
